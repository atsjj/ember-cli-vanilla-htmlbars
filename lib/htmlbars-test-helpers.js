...
exports.equalInnerHTML = equalInnerHTML;function equalHTML(node, html) {
  var fragment;
...
exports.equalHTML = equalHTML;// IE8 removes comments and does other unspeakable things with innerHTML
...
exports.equalTokens = equalTokens;// detect weird IE8 html strings
...
exports.normalizeInnerHTML = normalizeInnerHTML;// detect weird IE8 checked element string
...
exports.isCheckedInputHTML = isCheckedInputHTML;// check which property has the node's text content
...
exports.getTextContent = getTextContent;// IE8 does not have Object.create, so use a polyfill if needed.
