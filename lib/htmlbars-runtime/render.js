...
var ExpressionVisitor = require("./expression-visitor")["default"];
var AlwaysDirtyVisitor = require("./expression-visitor").AlwaysDirtyVisitor;
var Morph = require("./morph")["default"];
var clearMorph = require("../htmlbars-util/template-utils").clearMorph;

exports["default"] = function render(template, env, scope, options) {
  var dom = env.dom;
...
exports.manualElement = manualElement;RenderResult.prototype.render = function() {
...
exports.createChildMorph = createChildMorph;function getCachedFragment(template, env) {
