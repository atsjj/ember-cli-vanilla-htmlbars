...
exports.buildComment = buildComment;function buildConcat(parts) {
  return {
...
exports.buildConcat = buildConcat;function buildElementModifier(sexpr) {
  return {
...
exports.buildElementModifier = buildElementModifier;// Nodes
